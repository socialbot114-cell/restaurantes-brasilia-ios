...
enum CuisineStyle {
    ...
    static let map: [String: Identity] = [
        ...
        "sorveteria": Identity(symbol: "icecream.fill", tint: Color(red: 0.88, green: 0.54, blue: 0.42)),
        "gelateria": Identity(symbol: "icecream.fill", tint: Color(red: 0.88, green: 0.54, blue: 0.42)),
